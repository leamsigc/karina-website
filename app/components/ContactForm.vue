...
v-if="status === 'SUCCESS'"
            ...
            <button
type="button" class="text-navy-700 dark:text-navy-400 font-bold hover:underline text-lg uppercase tracking-wide"
                @click="status = 'IDLE'">
                Send another
            </button>
        </div>
...
v-else class="space-y-6" data-netlify="true" netlify data-netlify-honeypot="bot-field"
            ...
            <div>
                ...
                <input
v-model="form.name" name="name" required type="text"
            ...
            <div>
                ...
                <input
v-model="form.email" name="email" required type="email"
                    class="w-full px-5 py-4 rounded-sm bg-gray-50 dark:bg-navy-900 border-2 border-gray-200 dark:border-navy-700 focus:border-gold-500 focus:outline-none transition-colors text-lg text-navy-900 dark:text-white placeholder-gray-400"
            ...
            <div>
                ...
                <select
v-model="form.interest" name="interest" required
            ...
            <div>
                ...
                <textarea
v-model="form.message" name="message" required rows="5"
            ...
            <UButton
type="submit" :loading="status === 'SENDING'" block size="xl" color="primary" variant="solid"
