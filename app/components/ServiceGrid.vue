    ...
    <section class="py-24 bg-concrete-50 dark:bg-navy-900" id="services">
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div>
                    <span
                        ...
                        <slot name="subtitle" mdc-unwrap="p">Nuestra Experiencia</slot>
                    </span>
                    <h2
                        class="text-4xl md:text-6xl font-display font-bold text-navy-900 dark:text-navy-100 uppercase leading-none">
                        <slot name="title" mdc-unwrap="p">
                            Servicios <span
                                class="text-transparent bg-clip-text bg-gradient-to-br from-navy-900 to-navy-600 dark:from-white dark:to-gray-400">Legales</span>
                        </slot>
                    </h2>
                </div>
                <p class="text-gray-600 dark:text-gray-400 max-w-md text-lg leading-relaxed text-right md:text-left">
                    <slot name="description" mdc-unwrap="p">
                        Especialistas en asesoría legal patrimonial para propietarios en Oaxaca.
                    </slot>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:auto-rows-[300px]">
                ...
                <div
                    ...
                    <div class="relative z-10 flex flex-col h-full justify-between">
                        ...
                        <div>
                            <h3 class="text-3xl md:text-4xl font-display font-bold text-white mb-4">Reducción de
                                Predial
                            </h3>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-display font-bold text-white mb-2">Primera Asesoría Gratis</h3>
                    <p class="text-teal-100 mb-6">Sin compromiso. Te ayudamos a resolver tu caso.</p>
                    <NuxtLinkLocale to="/contact"
            ...
            <div class="mt-12 flex flex-wrap gap-2 justify-center">
                <span
                    v-for="tag in ['Predial Oaxaca', 'Avalúo Catastral', 'Regularización', 'Trámites Municipales', 'Defensa Legal', 'Propiedades', 'Reducción', 'Asesoría']"
                    :key="tag"
