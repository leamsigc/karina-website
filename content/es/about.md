...
<div class="prose prose-xl prose-slate dark:prose-invert mx-auto max-w-4xl my-16 font-serif font-light text-xl">
  ...
  <div class="bg-charcoal text-cream  border-l-8 border-navy-900 dark:border-navy-400 p-8 my-12 rounded-r-sm">
    <h3 class="text-2xl font-bold   mb-4 font-display">Mi Compromiso</h3>
  ...
  <h2 class="text-3xl font-display font-black text-dark    mt-16 mb-8">Especialidades</h2>
  ...
  <h2 class="text-3xl font-display font-black text-dark   mt-16 mb-8">¿Por Qué Elegirme?</h2>
  ...
  <h2 class="text-3xl font-display font-black text-dark   mt-16 mb-8">Contacto</h2>
  ...
  <h3 class="text-3xl font-display font-black text-dark   mt-16 mb-8 text-center uppercase">¿Tienes Problemas con tu Predial?</h3>
</div>
